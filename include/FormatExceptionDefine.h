...
public:
    ...
    static inline constexpr auto TIME_SPACE_EXCEPTION = "Временной промежуток должен содержать только один пробел";
    static inline constexpr auto NOT_DIGIT_CHAR_EXCEPTION = " не является цифрой. Этот символ(ы) не могут находиться в числе";
    ...
    static inline constexpr auto ATTR_SPACE_EXCEPTION = "Количество атрибутов в событии должно быть от 3 до 4. Найдено: ";
    ...
    static inline constexpr auto TIMELINE_INVALID_ORDER = "Время событий должно быть последовательным и линейным";
    static inline constexpr auto INVALID_CLIENT_NAME = "Имя клиента должно содержать только [a-z], [0-9], -, _ ";
